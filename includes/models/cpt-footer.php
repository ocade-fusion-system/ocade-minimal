...
add_action('init', function () {
  $labels = array(
    ...
    'menu_name' => __('Footer'),
    'all_items' => __('Footers'),
    'add_new' => __('Ajouter un nouveau'),
    'add_new_item' => __('Ajouter un nouveau footer'),
    'edit_item' => __('Modifier le footer'),
    'new_item' => __('Nouveau footer'),
    'view_item' => __('Voir le footer'),
    'search_items' => __('Rechercher des footers'),
    'not_found' => __('Aucun footer trouvé'),
    'not_found_in_trash' => __('Aucun footer trouvé dans la corbeille'),
  );
