...
add_action('init', function () {
  $labels = array(
    ...
    'add_new' => __('Ajouter un nouveau Author'),
    'add_new_item' => __('Ajouter un nouveau Author'),
    'edit_item' => __('Modifier l\'Author'),
    'new_item' => __('Nouveau Author'),
    'view_item' => __('Voir l\'Author'),
    'search_items' => __('Rechercher des Authors'),
    'not_found' => __('Aucun Author trouvé'),
    'not_found_in_trash' => __('Aucun Author trouvé dans la corbeille'),
  );
